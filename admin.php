...
if( $mysqli->connect_errno ) {
	...
	$sql = "SELECT id,view_name,message,post_date,edit_date FROM message ORDER BY post_date DESC";
...
<body>
    <a href="index.php">
        <input type="submit" name="btn_submit1" value="TOPへ戻る">
    </a>
            ...
            <div class="info">
                ...
                <div style="display:flex" style="float:right;">
                    ...
                    <a href="delete.php?message_id=<?php echo $value['id']; ?>">
                        <input type="submit" name="btn_submit3" value="削除">
                    </a>
                </div>
            </div>
