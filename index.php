...
if( $mysqli->connect_errno ) {
	...
	$sql = "SELECT view_name,message,post_date,edit_date,edit_date FROM message ORDER BY post_date DESC";
	$res = $mysqli->query($sql);
...
------------------------------*/
    body {
        padding: 50px;
        font-size: 100%;
        font-family: 'メイリオ', 'verdana', 'メイリオ', Meiryo, 'ＭＳ Ｐゴシック', sans-serif;
        color: #222;
        background: #f7f7f7;
    }
...
<body>
    <a href="admin.php">
        <text-decoration>
            <input type="submit" name="btn_submit1" value="管理画面へ">
        </text-decoration>
    </a>
    ...
    <form method="post">
        ...
        <text-decoration><input type="submit" name="btn_submit" value="投稿"></text-decoration>
