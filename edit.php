...
if( !empty($_GET['message_id']) && empty($_POST['message_id']) ) {
    ...
    $message_data['edit_date'] = date("Y-m-d H:i:s");
	...
	if( empty($error_message) ) {
		...
		if( $mysqli->connect_errno ) {
			...
			$sql = "UPDATE message SET view_name = '$message_data[view_name]', message= '$message_data[message]' , edit_date='$message_data[edit_date]' WHERE id =  $message_id";
			$res = $mysqli->query($sql);
		}
...
<body>
    ...
    <form method="post">
        ...
        <div>
            ...
            <textarea id="message"
                name="message"><?php if( !empty($message_data['message']) ){ echo $message_data['message']; } ?></textarea>
        </div>
